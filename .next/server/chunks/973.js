...
const services4_namespaceObject = JSON.parse('[{"id":1,"title":"Talent Search","icon":"pe-7s-id","content":"At this university, we are looking for top talents and the emergence of world champions"},{"id":2,"title":"Personal and growth","icon":"pe-7s-rocket","content":"Personal growth of students is our main mission in this sports university"},{"id":3,"title":"Global pride","icon":"pe-7s-cup","content":"By passing academic and skill courses after graduation, you will surely be the world champions."}]');
...
const team1_namespaceObject = JSON.parse('[{"id":1,"image":"/img/team/01.jpg","name":"Hasib sharif","title":"Fitness Instructor"},{"id":2,"image":"/img/team/02.jpg","name":"maxo Leo","title":"Psychologist"},{"id":3,"image":"/img/team/03.jpg","name":"Leio Man","title":"financial manager"},{"id":4,"image":"/img/team/4.jpg","name":"Robert Front","title":"Physical Instructor"},{"id":5,"image":"/img/team/5.jpg","name":"Legender Mao","title":"Master of Body Anatomy"},{"id":6,"image":"/img/team/6.jpg","name":"Matt Huk","title":"Karate instructor"}]');
