                    ...
                    <div className="full-width">
                      ...
                      <h6 className="custom-font">
                        <Link href="/blog-details/blog-details-dark">
                          How to have a healthy diet in the club?
                        </Link>
                      </h6>
                ...
                <div className="item">
                  ...
                  <div className="cont valign">
                    <div className="full-width">
                      ...
                      <h6 className="custom-font">
                        <Link href="/blog-details/blog-details-dark">
                         What could be the cause of a heart attack while training at the gym?
                        </Link>
                      </h6>
                      <div className="btn-more custom-font">
                        <Link href="/blog-details/blog-details-dark">
                ...
                <div className="item">
                  ...
                  <div className="cont valign">
                    <div className="full-width">
                      ...
                      <h6 className="custom-font">
                        <Link href="/blog-details/blog-details-dark">
                         Rock climbing competitions were held in Argentina
                        </Link>
                      </h6>
                      <div className="btn-more custom-font">
                        <Link href="/blog-details/blog-details-dark">
